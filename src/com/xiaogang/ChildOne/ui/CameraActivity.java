...
import com.xiaogang.ChildOne.ui.CameraActivity;
...
import com.zxingcamera.CameraManager;
...
public class CameraActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		Log.i("CameraActivity", resultString);
		if (resultString.equals("")) {
			Toast.makeText(CameraActivity.this, "ɨ��ʧ��!", Toast.LENGTH_SHORT).show();
		}else {

...
public class TeacherSettingActivity extends BaseActivity implements View.OnClickListener{
    private static final String TAG = TeacherSettingActivity.class.getSimpleName();
    ...
    private void initData(){
        name.setText(account.getNick_name());
        imageLoader.displayImage(account.getCover(), tx, HomeBabyApplication.txOptions, animateFirstListener);
    }

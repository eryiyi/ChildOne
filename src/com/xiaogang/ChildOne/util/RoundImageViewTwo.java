 ...
 * @author Alan
 */
public class RoundImageViewTwo extends ImageView {
	...
	public RoundImageViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setCustomAttributes(attrs);
	}

	public RoundImageViewTwo(Context context, AttributeSet attrs, int defStyle) {
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
		...
		if (bmpHeight > bmpWidth) {// 高大于宽
			squareWidth = squareHeight = bmpWidth/2;
			x = 0;
			...
			squareWidth = squareHeight = bmpHeight/2;
